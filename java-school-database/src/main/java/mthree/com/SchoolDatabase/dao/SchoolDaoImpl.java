    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = "SELECT c.courseCode, c.courseDesc FROM course c RIGHT JOIN teacher t ON c.teacherId = t.tId WHERE t.dept = 'Computer Science'";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(sc.student_id) AS numStudents " +
                "FROM course c INNER JOIN course_student sc ON c.cid = sc.course_id " +
